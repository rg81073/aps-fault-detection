...
class DataValidation:
    ...
    def drop_missing_values_columns(self,df:pd.DataFrame,report_key_name:str)->Optional[pd.DataFrame]:
        """
        This function will drop column which contain misisng value more than specific threshold
        ...
        try:
            ...
            logging.info(f"selecting column name which contain null value above to {threshold}")
    ...
    def initiate_data_validation(self)->artifact_entity.DataValidationArtifact:
        try:
            ...
            train_df = self.drop_missing_values_columns(df=train_df,report_key_name="missing_values_within_train_datset")
